...
export default {
  ...
  getForecast() {
    ...
    axios.get(`https://api.weatherapi.com/v1/forecast.json?key=${key}&q=${country}&days=3`)
      .then((response) => {
